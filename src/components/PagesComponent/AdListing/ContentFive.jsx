...
import { FaAngleDown, FaLocationCrosshairs } from 'react-icons/fa6';
        ...
        <>
            <div className="col-12">
                <div className='extra_det_loc_cont'>
                    <button className={`select_manually ${ActiveLocation === 'manually' && 'active_bg'}`} onClick={handleSelectManually}>{t('selectManually')}</button>
                    <button className={`extra_det_loc ${ActiveLocation === 'locate' && 'active_bg'}`} onClick={getCurrentLocation} >
